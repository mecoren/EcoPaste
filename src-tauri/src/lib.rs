...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::set_clipboard_items_favorite,
            commands::set_clipboard_items_pinned,
            commands::move_clipboard_items_to_group,
            ...
            commands::search_typing_ack,
            commands::show_clipboard_preview,
            commands::close_clipboard_preview,
            commands::get_clipboard_preview_state,
            commands::set_clipboard_preview_panel_rect,
            commands::set_clipboard_preview_pointer,
