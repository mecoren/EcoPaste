...
export const TAURI_COMMAND = {
  ...
  EXPORT_ITEMS_BACKUP: "export_items_backup",
  ...
  GET_PROCESS_MEMORY_STATS: "get_process_memory_stats",
  ...
  MOVE_CLIPBOARD_ITEMS_TO_GROUP: "move_clipboard_items_to_group",
  ...
  SEARCH_TYPING_ACK: "search_typing_ack",
