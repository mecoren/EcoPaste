...
* 多选文本条目可合并粘贴为一条，并自动清理粘贴文本

### 🐛 问题修复

* 重新打开剪贴板窗口时会加载隐藏期间复制的新内容，无需切换分组手动刷新

## [1.2.5](https://github.com/mecoren/EcoPaste/compare/v1.2.4...v1.2.5) (2026-09-15)

### ✨ 新功能

* 悬浮预览现在可交互：长内容可滚动查看；可拖选文字并通过浮动按钮或面板右上角按钮只复制选中片段；单图文件也按图片预览并支持灯箱

### 🐛 问题修复

* 修复点击可交互预览面板时预览被自己关掉的问题（面板抢走主窗焦点触发失焦关闭）
